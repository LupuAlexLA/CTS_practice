package practiceInainteDeTest1._00_RecapTest.builder.classes;
...
public class HolidayBuilder {
    ...
    public HolidayPackage build() {
        return new HolidayPackage(transportType, nightsOfAccommodation, roomType,
            hotelRanking, extraActivities, price);
    }
}

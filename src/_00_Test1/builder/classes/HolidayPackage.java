package _00_Test1.builder.classes;
...
public class HolidayPackage implements AbstractHolidayPackage {
    ...
    HolidayPackage(String transportType, int nightsOfAccommodation, String roomType, int hotelRanking, String[] extraActivities, float price) {
